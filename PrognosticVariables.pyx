...
cdef class SecondOrderMomenta:
    ...
    cpdef plot(self, str message, Grid Gr, TimeStepping TS):
        ...
        if np.mod(TS.t,TS.plot_freq) < TS.dt:
            ...
            plt.title('thth, max:' + np.str(np.round(np.amax(np.abs(values[th_varshift,th_varshift:])),6)), fontsize=10)
            plt.subplot(1,4,2)
            ...
            plt.title('ww, max:' + np.str(np.round(np.amax(np.abs(values[w_varshift,w_varshift:])),6)), fontsize=10)
            plt.subplot(1,4,3)
            ...
            plt.title('uw, max:' + np.str(np.round(np.amax(np.abs(values[u_varshift,w_varshift:])),6)), fontsize=10)
            plt.subplot(1,4,4)
            ...
            plt.title('wth, max:' + np.str(np.round(np.amax(np.abs(values[w_varshift,th_varshift:])),6))+ ', ' + message, fontsize=10 )
    ...
    cpdef plot_tendencies(self, str message, Grid Gr, TimeStepping TS):
        ...
        if np.mod(TS.t,TS.plot_freq) < TS.dt:
            ...
            plt.title('thth tend, '+np.str(np.round(np.amax(np.abs(tendencies[th_varshift,th_varshift,gw:gw+nz])),6)),fontsize=10)
            plt.subplot(1,4,2)
            ...
            plt.title('ww tend,'+np.str(np.round(np.amax(np.abs(tendencies[w_varshift,w_varshift,gw:gw+nz])),6)),fontsize=10)
            plt.subplot(1,4,3)
            ...
            plt.title('uw tend,'+np.str(np.round(np.amax(np.abs(tendencies[u_varshift,w_varshift,gw:gw+nz])),6)),fontsize=10)
            plt.subplot(1,4,4)
            ...
            plt.title('wth tend,'+np.str(np.round(np.amax(np.abs(tendencies[w_varshift,th_varshift,gw:gw+nz])),6)),fontsize=10)
